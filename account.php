...
$fn->Authpage();
$user = $db->query("SELECT full_name,email FROM user WHERE id='".$fn->Auth()['id']."'");
            ...
            <div>
                ...
                <form class="row g-3 p-3" action="action/updateprofile.action.php" method="post">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="fullname" placeholder="Imran Alam" value="<?=@$user['full_name']?>"class="form-control" required>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Email</label>
                        <input type="email" name="email" placeholder="imran@abc.com" value="<?=@$user['email']?> "class="form-control" required>
                    </div>
                    <div class="col-12">
