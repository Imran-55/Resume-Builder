...
// $fn->Authpage();
$resumes = $db->query("SELECT * FROM detail WHERE  user_id = " . $fn->Auth()['id'] );
                ...
                <div class="col-12 col-md-6 p-2">
                    <div class="p-2 border rounded">
                        ...
                        <div class="d-flex gap-2 mt-1">
                            <a href="resume.php?resume=<?= $resume['sludg']?>" class="text-decoration-none small" target="_blank"><i class="bi bi-file-text"></i> Open</a>
                            <a href="updateresume.php?resume=<?= $resume['sludg']?>" class="text-decoration-none small"><i class="bi bi-pencil-square"></i> Edit</a>
                            <a href="action/deleteresume.action.php?id=<?=$resume['id']?>" class="text-decoration-none small"><i class="bi bi-trash2"></i> Delete</a>
